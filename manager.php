...
if(isset($_GET['lang'])) {
    echo $translate['msgMan'] .' '.  $_SESSION['name'].' ' . $_SESSION['surname'] . $translate['msgMan2'];
}

echo '<br><a href="manager.php?lang=ru">Русский</a>';
echo '<br><a href="manager.php?lang=en">Англиский</a>';